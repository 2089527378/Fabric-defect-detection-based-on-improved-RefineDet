        ...
        for xml_name in files:
            ...
            for i in range(crop_n):
                ...
                croped_img_name = xml_name.split('.')[0]+'_'+name_suffix +\
                            ...
                            '.'+img_file.split('.')[-1]
                croped = crop_img_xml(img,get_xml_tree(xml_file),croped_img_name,crop_top_left_x,crop_top_left_y,crop_imgw,crop_imgh,iou_thr)
...
def main():
    ...
    imgs_save_dir= 'C:/Users/zxl/Desktop/test/crop_imgs/'
    if not os.path.exists(imgs_save_dir):
        os.makedirs(imgs_save_dir)
    xmls_save_dir='C:/Users/zxl/Desktop/test/crop_xmls/'
