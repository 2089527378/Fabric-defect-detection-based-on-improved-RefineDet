...
class RefineDet_sam(nn.Module):
    """Single Shot Multibox Architecture adding SAM block
    ...
    def __init__(self, phase, size, base, extras, ARM, ODM, TCB, num_classes):
        super(RefineDet_sam, self).__init__()
        self.phase = phase
...
def build_refinedet_sam(phase, size=320, num_classes=21):
    ...
    return RefineDet_sam(phase, size, base_, extras_, ARM_, ODM_, TCB_, num_classes)
