...
class RefineDet_novel_sam(nn.Module):
    """Single Shot Multibox Architecture adding BA-TCB, SAM block
    ...
    def __init__(self, phase, size, base, extras, ARM, ODM, TCB,TCB_add, num_classes):
        super(RefineDet_novel_sam, self).__init__()
        self.phase = phase
        ...
        self.list_cam = nn.ModuleList(
            [SAM(512, 16), SAM(512, 16), SAM(1024, 16), SAM(512, 16), SAM(256, 16), SAM(256, 16), SAM(256, 16),
             SAM(256, 16), ])
...
def build_refinedet_novel_sam(phase, size=320, num_classes=21):
    ...
    return RefineDet_novel_sam(phase, size, base_, extras_, ARM_, ODM_, TCB_,TCB_add, num_classes)
