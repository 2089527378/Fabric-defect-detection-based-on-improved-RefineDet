...
class RefineDetMultiBoxLoss3(nn.Module):
    """DIoU-based Weighted Loss Function
    Compute Targets:
    ...
    def __init__(self, num_classes, overlap_thresh, prior_for_matching,
        ...
        super(RefineDetMultiBoxLoss3, self).__init__()
    ...
    def forward(self, predictions, targets):
        ...
        if self.use_ARM:
            loss_l = diou_loss(loc_p, loc_t, reduction="sum")
