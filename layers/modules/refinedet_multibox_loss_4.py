...
from data.config import coco_refinedet as cfg
...
class RefineDetMultiBoxLoss4(nn.Module):
    """CIoU-based Weighted Loss Function
    Compute Targets:
    ...
    def __init__(self, num_classes, overlap_thresh, prior_for_matching,
        ...
        super(RefineDetMultiBoxLoss4, self).__init__()
        ...
        self.gious=IouLoss(pred_mode = 'Center',size_sum=True,variances=self.variance, losstype='Ciou')
